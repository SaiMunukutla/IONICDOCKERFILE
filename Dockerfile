...
#RUN echo y | android update sdk --all --no-ui --filter addon-google_apis_x86-google-23
#RUN echo y | android update sdk --all --no-ui --filter extra-android-support,extra-android-m2repository,extra-google-m2repository,sys-img-x86-android-23
